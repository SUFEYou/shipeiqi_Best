...
void WidgeVHF171al::setVolume(int volumnLev)
{
...
void WidgeVHF171al::setBkLight(int bkLightLev)
{
...
void WidgeVHF171al::setTmpChannel(QString param)
{
...
void WidgeVHF171al::cancelTmpChannel()
{
...
void WidgeVHF171al::onKey(int key)
{
    if(key == 0x41){
        onKeyA();
    }
...
void WidgeVHF171al::onKeyChannelUp()
{
...
void WidgeVHF171al::onKeyChannelDw()
{
...
void WidgeVHF171al::onKeyCancel()
{
    cancelTmpChannel();
}

void WidgeVHF171al::onKeyConfirm()
{
...
void WidgeVHF171al::onKey0()
{
    setTmpChannel("0");
}

void WidgeVHF171al::onKey1()
{
    setTmpChannel("1");
}

void WidgeVHF171al::onKey2()
{
    setTmpChannel("2");
}

void WidgeVHF171al::onKey3()
{
    setTmpChannel("3");
}

void WidgeVHF171al::onKey4()
{
    setTmpChannel("4");
}

void WidgeVHF171al::onKey5()
{
    setTmpChannel("5");
}

void WidgeVHF171al::onKey6()
{
    setTmpChannel("6");
}

void WidgeVHF171al::onKey7()
{
    setTmpChannel("7");
}

void WidgeVHF171al::onKey8()
{
    setTmpChannel("8");
}

void WidgeVHF171al::onKey9()
{
    setTmpChannel("9");
}

void WidgeVHF171al::onKeyUp()
{
    qDebug()<<"上";
}

void WidgeVHF171al::onKeyDw()
{
    qDebug()<<"下";
}

void WidgeVHF171al::onKeyLeft()
{
    qDebug()<<"左";
}

void WidgeVHF171al::onKeyRight()
{
    qDebug()<<"右";
}

void WidgeVHF171al::resetIconMovie()
{
    if(lightLev == 0){
        if(pttAck == 1) {
