...
void WidgeSSB212::setVolume(int volumnLev)
{
...
void WidgeSSB212::setBkLight(int bkLightLev)
{
    // 面板背景
...
void WidgeSSB212::setTmpChannel(QString param)
{
...
void WidgeSSB212::cancelTmpChannel()
{
...
void WidgeSSB212::showChnlErr(bool isErr) {
    // 恢复临时默认信道
    tmpChannel = "000";
    isSettingChnl = false;
...
void WidgeSSB212::setTmpFreq(QString param)
{
...
void WidgeSSB212::cancelTmpFreq()
{
...
void WidgeSSB212::showFreqErr(bool isErr) {
    lblRxFreq = NULL;
    lblTxFreq = NULL;
    // 恢复临时值
    tmpFreq = "";
...
void WidgeSSB212::onKey(int key)
{
    if(key == 0x41){
        onKeyA();
    }
...
void WidgeSSB212::onKeyChannelUp()
{
...
void WidgeSSB212::onKeyChannelDw()
{
    int currChanl = tmpChannel.toInt();
    if(!isSettingChnl){
        currChanl = curChannel.toInt();
...
void WidgeSSB212::onKeyCancel()
{
    cancelTmpFreq();
    cancelTmpChannel();
}

void WidgeSSB212::onKeyConfirm()
{
...
void WidgeSSB212::onKey0()
{
    keyInputParam("0");
}

void WidgeSSB212::onKey1()
{
    keyInputParam("1");
}

void WidgeSSB212::onKey2()
{
    keyInputParam("2");
}

void WidgeSSB212::onKey3()
{
    keyInputParam("3");
}

void WidgeSSB212::onKey4()
{
    keyInputParam("4");
}

void WidgeSSB212::onKey5()
{
    keyInputParam("5");
}

void WidgeSSB212::onKey6()
{
    keyInputParam("6");
}

void WidgeSSB212::onKey7()
{
    keyInputParam("7");
}

void WidgeSSB212::onKey8()
{
    keyInputParam("8");
}

void WidgeSSB212::onKey9()
{
    keyInputParam("9");
}

void WidgeSSB212::onKeyUp()
{
    cancelTmpChannel();
    cancelTmpFreq();
...
void WidgeSSB212::keyInputParam(QString param)
{
    if(isSettingChnl) {
        setTmpChannel(param);
    }
...
void WidgeSSB212::setRxFreq(int param)
{
    int freqBar = this->getFreqBar(param);
    ui->barRx->setValue(freqBar);
}

void WidgeSSB212::setTxFreq(int param)
{
    int freqBar = this->getFreqBar(param);
    ui->barTx->setValue(freqBar);
}

int WidgeSSB212::getFreqBar(int param)
{
...
void WidgeSSB212::resetIconMovie()
{
    if(lightLev == 0){
        if(pttAck == 1) {
...
bool WidgeSSB212::freqOverRange(const int curFreq)
{
